...
public class CallbackRegistration implements HandlerRegistration {
	...
	public EventDispatcher getUiObject() {
		return uiObject;
	}
	...
	public native void unregister() /*-{
		var obj = this.@com.ait.toolkit.flash.core.client.events.CallbackRegistration::getUiObject()();
		var objjso = obj.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		var action = this.@com.ait.toolkit.flash.core.client.events.CallbackRegistration::getActionString()();
		var jso = this.@com.ait.toolkit.flash.core.client.events.CallbackRegistration::getJso()();
