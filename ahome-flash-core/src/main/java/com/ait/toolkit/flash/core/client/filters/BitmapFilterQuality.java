...
public enum BitmapFilterQuality {
    ...
    public static native BitmapFilterQuality fromValue(int value) /*-{
		switch (value) {
		case 3:
			return @com.ait.toolkit.flash.core.client.filters.BitmapFilterQuality::HIGH;

		case 1:
			return @com.ait.toolkit.flash.core.client.filters.BitmapFilterQuality::LOW;

		case 2:
			return @com.ait.toolkit.flash.core.client.filters.BitmapFilterQuality::MEDIUM;
