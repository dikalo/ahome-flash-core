...
public enum Direction {
    ...
    public static native Direction fromValue(String value) /*-{
		switch (value) {
		case 'L2R':
			return @com.ait.toolkit.flash.alivepdf.client.viewing.Direction::LEFT_TO_RIGHT;
		case 'R2L':
			return @com.ait.toolkit.flash.alivepdf.client.viewing.Direction::RIGHT_TO_LEFT;
		}
    }-*/;
